import { ChevronsLeft, ChevronsRight, Pause, Play, RotateCcw } from 'lucide-react'
    ...
    <div className="flex items-center gap-3 border-t bg-card px-3 py-2">
      ...
      <div className="flex-1">
        <ElasticSlider
          ...
          step={1}
          onChange={(v) => seek(v)}
          leftIcon={<ChevronsLeft className="size-3.5" />}
          rightIcon={<ChevronsRight className="size-3.5" />}
        />
      </div>
