// React Bits  DotField. Interactive dot grid with cursor bulge + glow. Canvas.
...
export const DotField = memo(function DotField({
  ...
  bulgeStrength = 58,
  glowRadius = 150,
  gradientFrom = 'rgba(57,183,201,0.30)',
  gradientTo = 'rgba(57,183,201,0.10)',
  glowColor = 'rgba(57,183,201,0.35)',
}: Props) {
  ...
  useEffect(() => {
    ...
    const onMove = (e: MouseEvent) => {
      mouseRef.current.x = e.pageX - sizeRef.current.ox - window.scrollX
      mouseRef.current.y = e.pageY - sizeRef.current.oy - window.scrollY
    }
